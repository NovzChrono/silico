                ...
                <div className=''>
                    <div className="container mx-auto">
                        <div className='flex text-3xl pt-10 border-b-2 pb-2 mb-12'>
                            <div className='pt-1 px-3'><GiTicket /></div>
                            <div>3D Structure</div>
                        </div>
                        <div className="">
